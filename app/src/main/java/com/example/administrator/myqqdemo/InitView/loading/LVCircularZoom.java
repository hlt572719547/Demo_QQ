package com.example.administrator.myqqdemo.InitView.loading;
...
public class LVCircularZoom extends View {
    ...
    public LVCircularZoom(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxRadius = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6, context.getResources().getDisplayMetrics());
        initPaint();
    }
